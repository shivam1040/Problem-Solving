...
curr as 2 3 4
node as 2 3 4
store next of curr in new var
replace next of curr with previous, this change will reflect in node variable too i.e. 2 1  
now next of prev should point to next of above new var
update curr and prev counter
loop
*/
    ...
    class Solution {
        ...
        public Node pairwiseSwap(Node node)
        {
            ...
            while (true) {
                ...
                // If next NULL or next is the last node, ensuring at leat two nodes present for swapping
